          ...
          <div class="col-md-12">
                      <form class="theme-form" action="update.php" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="row g-2">
                            <div class="col-6">
                              <input class="form-control" type="text" required="" value="<?php echo $row['name']; ?>" name="fname">
                            </div>
                            <div class="col-6">
                              <input class="form-control" type="text" required="" value="<?php echo $row['lname']; ?>" name="lname">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="number" required="" value="<?php echo $row['number']; ?>" name="number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Email Address</label>
                                  <input class="form-control" type="email" required="" value="<?php echo $row['gmail']; ?>" name="email">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Company Name</label>
                                  <input class="form-control" type="text" required="" value="<?php echo $row['company_name']; ?>" name="company">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Contact Person Number</label>
                                  <input class="form-control" type="number" required="" value="<?php echo $row['owner_mobile_number']; ?>" name="p_number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Contact Person Email</label>
                                  <input class="form-control" type="email" required="" value="<?php echo $row['owner_gmail']; ?>" name="p_email">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" required="" value="<?php echo $row['gst']; ?>" name="gst">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Pan Card No.</label>
                                  <input class="form-control" type="text" required="" value="<?php echo $row['pan']; ?>" name="pan">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-2">
                                <div class="col-form-label">City</div>
                                <select class="js-example-basic-single col-sm-12" name="city" value="<?php echo $row['city']; ?>">
                            ...
                            <div class="col-md-12">
                                <div class="mb-2">
                                      <div class="col-form-label">Services</div>
                                      <select class="js-example-basic-multiple col-sm-12" value="<?php echo $row['services']; ?>" name="service">
                                        <option value="" selected>Service</option>
                                        <option value="">Remote DME</option>
                                        <option value="">Process Maintenance</option>
                                        <option value="">Secure Support</option>
                                        <option value="">DME Training</option>
                                        <option value="">Web Development and Designing</option>
                        ...
                        <div class="form-group mb-0">
                          ...
                          <button class="btn btn-primary btn-block w-100" type="submit" name="submit">Update</button>
                        </div>
