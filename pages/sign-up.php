            ...
            <div>
              <div class="login-main"> 
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <form class="theme-form" action="registraition.php" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="number" required="" placeholder="4343434333" name="number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" required="" placeholder="instasoft" name="company">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Contact Person Number</label>
                                  <input class="form-control" type="number" required="" placeholder="3434343434" name="p_number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Contact Person Email</label>
                                  <input class="form-control" type="email" required="" placeholder="demo@.com" name="p_email">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" required="" placeholder="234 345 345 67 8" name="gst">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label class="col-form-label">Pan Card No.</label>
                                  <input class="form-control" type="text" required="" placeholder="334455" name="pan">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-2">
                                <div class="col-form-label">City</div>
                                <select class="js-example-basic-single col-sm-12" name="city">
                            ...
                            <div class="col-md-12">
                                <div class="mb-2">
                                      ...
                                      <select class="js-example-basic-multiple col-sm-12" multiple="multiple" name="service">
