              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header" style="padding:15px; text-align: right;">
                    ...
                    <!-- <a href="addschedulemeet.php" class="btn btn-primary"> Add Schedule Meeting</a> -->
                  </div>
                  <div class="card-body">
                    ...
                    <?php
                           $id = $_SESSION["user_id"];
                            ...
                            $sql= "SELECT * FROM `schedule_list` WHERE schedule_list.pos = 2 AND schedule_list.link = $id AND schedule_list.request = 'Accept'";
