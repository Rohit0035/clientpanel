              ...
              <div class="row">
                ...
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">In-Process Task</li>
                  </ol>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      <?php 
                            ...
                            WHERE assign_task.fld_status  = 1 AND task.client_id = $id";
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                          <?php 	if(mysqli_num_rows($results)>0){
                            ...
                            <!-- <td><a class="btn btn-danger btn-xs" href="delete-task.php?id=<?php echo $row['id_acc'] ?>"><i class="fas fa-trash-alt"></i></a>
